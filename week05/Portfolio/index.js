...
http.createServer((req, res) => {
    ...
    fs.stat(fullPathUrl, (err, stat) => {
        ...
        //no - serve the file
        if (stat.isFile()) {
            const extension = path.extname(fullPathUrl);
    ...
    // part2 lowprioryty
    // req just / generate html to send back
    // function create, generate htnmk callback, passed
    // <!doctype html>
    // <title>My Great Work</title>
    // <ul>
    //     <li><a href = "/carusel/">carusel</a>
    //     <li><a href = "/ticler/">ticker</a>
    // <ul>
    // });
